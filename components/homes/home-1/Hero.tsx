              ...
              <div className="mxd-hero-01__title-wrap">
                ...
                <h1 className="hero-01-title">
                  ...
                  <span className="hero-01-title__row loading__item">
                    ...
                    <em className="hero-01-title__item">that Transforms Brands</em>
                  </span>
                </h1>
              </div>
            </div>
              ...
              <div className="mxd-hero-01__data-wrap">
                ...
                <div className="mxd-hero-01__data-descr loading__fade">
                  <p className="t-bright">
                    We are an AI-first digital marketing agency delivering end-to-end brand growth—
 from strategic design and high-performance digital campaigns to print, automation, and next-gen technology solutions.
                  </p>
                </div>
