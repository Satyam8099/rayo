              ...
              <div className="mxd-services-stack__inner justify-between bg-base-opp">
                ...
                <div className="mxd-services-stack__info width-60">
                  ...
                  <p className="t-small-mobile t-opposite">
                    ...
                    Our creative team blends strategy, storytelling, 
                    and AI-driven design to craft graphics that elevate your brand and connect 
                    instantly with your audience. From websites and product packaging to motion 
                    graphics and 3D assets, we create designs that leave a lasting impression and
              ...
              <div className="mxd-services-stack__inner radius-dark justify-between bg-base-tint">
                ...
                <div className="mxd-services-stack__info width-60">
                  ...
                  <p className="t-small-mobile">
                    We create brand identities that feel authentic, memorable, and aligned with your business goals. From logo design to complete brand systems, we ensure every visual and message stays consistent across all platforms, helping your brand build trust and stand out in the market.
                  </p>
                </div>
                <div className="services-stack__image">
                  <Image
